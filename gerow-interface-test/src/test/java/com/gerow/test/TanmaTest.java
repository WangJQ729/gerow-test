...
public class TanmaTest {
    ...
    public void test() throws NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        String timestamp = "1679225370059";
        String body = "{\"customerName\":\"【pf】宋士辉(1679225370)\",\"mobiles\":[\"86167922537005963\"],\"fields\":[]}";
        String str = appId + timestamp + body + appKey;
        str = "ww9c5530210a0d5116_lFERAr1627038225577{\"hello\": \"tanmarket\"}Chey5yRnVGnb7N5Kp9yA9cfU3mTtUuO4";
