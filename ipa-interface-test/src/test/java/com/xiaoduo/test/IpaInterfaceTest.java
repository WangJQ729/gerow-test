...
public class IpaInterfaceTest extends JQAbstractApiTest {

    public IpaInterfaceTest(ITestClass testClass) {
        super(testClass);
    }
    ...
    public static class JQApiTestFactory {
        ...
        public static Object[] dataFactory() throws UnsupportedEncodingException {
            ...
            String testDirPath = Objects.requireNonNull(IpaInterfaceTest.class.getClassLoader().getResource(testDir)).getFile();
        ...
        private static Object buildTestClass(ITestClass testClass) {
            ...
            try {
                //生成构造方法并实例化
                JavassistUtils.setConstructor(pool, className, ct, IpaInterfaceTest.class);
            ...
            return new IpaInterfaceTest(testClass);
        }
    }
}
